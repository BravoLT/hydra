...
using DayOneConsoleAppLogic.Classes.ItemManagement.Inventories;


namespace DayOneConsoleAppLogicTests.InterfaceTests
{
    [TestClass]
    public class NonEquippableInventoryTests
    {
        private NonEquippableInventory items;
        ...
        public void Initialize()
        {
            ...
            items = new NonEquippableInventory(heightDimension, widthDimension);
            addItem = true;
